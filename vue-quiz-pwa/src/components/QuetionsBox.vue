  ...
  <div>
    ...
    <div class="question-box-container col-xs-12">
      <b-jumbotron>
        ...
        <b-button @click="back" :disabled=" quetionIndex === 0" variant="success">Previous</b-button>
        <b-button
          variant="primary"
          :disabled="selectedIndex === null || answered"
          @click="submitAnswer"
        >Submit Ans</b-button>
        <b-button @click="next" :disabled=" quetionIndex === 9" variant="success">Next</b-button>
      </b-jumbotron>
    </div>
  </div>
</template>
